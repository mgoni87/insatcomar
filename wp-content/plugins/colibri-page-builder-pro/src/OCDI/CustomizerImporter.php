    ...
    public static function import( $customizer_import_file_path ) {
        ...
        if ( is_wp_error( $results ) ) {
            ...
            Helpers::append_to_file(
                $error_message,
                $log_file_path,
                esc_html__( 'Importing customizer settings', 'colibri-page-builder')
            );
        } else {
            // Add this message to log file.
            $log_added = Helpers::append_to_file(
                esc_html__( 'Customizer settings import finished!', 'colibri-page-builder'),
                $log_file_path,
                esc_html__( 'Importing customizer settings', 'colibri-page-builder')
            );
        }
...
//        $template = get_template();
        ...
        if ( ! is_array( $data ) && ( ! isset( $data['template'] ) || ! isset( $data['mods'] ) ) ) {
            return new WP_Error(
                ...
                esc_html__( 'Error: The customizer import file is not in a correct format. Please make sure to use the correct customizer import file.', 'colibri-page-builder')
            );
        }
...
//                esc_html__( 'Error: The customizer import file is not suitable for current theme. You can only import customizer settings for the same theme or a child theme.', 'colibri-page-builder')
//            );
//        }

        // Import images.
        if ( apply_filters( 'extendthemes-ocdi/customizer_import_images', true ) ) {
