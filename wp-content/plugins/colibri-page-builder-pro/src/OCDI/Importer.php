...
class Importer {
    ...
    public function import_content( $import_file_path ) {
        ...
        if ( ! apply_filters( 'extendthemes-ocdi/regenerate_thumbnails_in_content_import', true ) ) {
    ...
    public function new_ajax_request_maybe( $data ) {
        ...
        if ( $time > apply_filters( 'extendthemes-ocdi/time_for_one_ajax_call', 25 ) ) {
            $response = array(
                'status'  => 'newAJAX',
            ...
            $log_added = Helpers::append_to_file(
                __( 'New AJAX call!', 'colibri-page-builder' ) . PHP_EOL . $message,
