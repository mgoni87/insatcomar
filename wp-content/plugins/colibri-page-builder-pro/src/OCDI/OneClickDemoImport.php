...
//		add_action( 'admin_enqueue_scripts', array( $this, 'admin_enqueue_scripts' ) );
        add_action( 'wp_ajax_extendthemes_ocdi_import_demo_data', array( $this, 'import_demo_data_ajax_callback' ) );
        add_action( 'wp_ajax_extendthemes_ocdi_import_customizer_data', array(
            $this,
            'import_customizer_data_ajax_callback'
        ) );
        add_action( 'wp_ajax_extendthemes_ocdi_after_import_data', array(
            $this,
    ...
    public function create_plugin_page() {
        $this->plugin_page_setup = apply_filters( 'extendthemes-ocdi/plugin_page_setup', array(
        ...
        $this->plugin_page = add_submenu_page(
            ...
            apply_filters( 'extendthemes-ocdi/plugin_page_display_callback_function', array(
                $this,
                'display_plugin_page'
            ) )
        );

        register_importer( $this->plugin_page_setup['menu_slug'], $this->plugin_page_setup['page_title'], $this->plugin_page_setup['menu_title'], apply_filters( 'extendthemes-ocdi/plugin_page_display_callback_function', array(
            $this,
            'display_plugin_page'
        ) ) );
    }
    ...
    public function import_demo_data_ajax_callback() {
        ...
        if ( ! $use_existing_importer_data ) {
            ...
            if ( ! empty( $_FILES ) ) { // Using manual file uploads?
                ...
                $this->import_files[ $this->selected_index ]['import_file_name'] = esc_html__( 'Manually uploaded files', 'colibri-page-builder' );
                ...
                if ( is_wp_error( $this->selected_import_files ) ) {
                    ...
                    Helpers::log_error_and_send_ajax_response(
                        ...
                        $this->log_file_path,
                        esc_html__( 'Downloaded files', 'colibri-page-builder' )
                    );
                }
                ...
                wp_send_json( esc_html__( 'No import files specified!', 'colibri-page-builder' ) );
            }
        }
        ...
        if ( ! $this->before_import_executed ) {
            ...
            /**
             * 2). Execute the actions hooked to the 'extendthemes-ocdi/before_content_import_execution' action:
             *
             * Default actions:
             * 1 - Before content import WP action (with priority 10).
             */
            do_action( 'extendthemes-ocdi/before_content_import_execution', $this->selected_import_files, $this->import_files, $this->selected_index );
        }
        ...
        /**
         * 4). Execute the actions hooked to the 'extendthemes-ocdi/after_content_import_execution' action:
         *
         * Default actions:
         ...
         */
        do_action( 'extendthemes-ocdi/after_content_import_execution', $this->selected_import_files, $this->import_files, $this->selected_index );
        ...
        if ( false !== has_action( 'extendthemes-ocdi/after_all_import_execution' ) ) {
    ...
    public function import_customizer_data_ajax_callback() {
        ...
        if ( $this->use_existing_importer_data() ) {
             ...
             */
            do_action( 'extendthemes-ocdi/customizer_import_execution', $this->selected_import_files );
        }
    ...
    public function after_all_import_data_ajax_callback() {
        ...
        if ( $this->use_existing_importer_data() ) {
             ...
             */
            do_action( 'extendthemes-ocdi/after_all_import_execution', $this->selected_import_files, $this->import_files, $this->selected_index );
        }
