		...
		<form action='<?php echo esc_attr( $_view['action_url'] ); ?>' method='post' class="wds-form">
			...
			$this->render_view(
				...
				array(
					...
					'tab_name'     => __( 'General Settings', 'smartcrawl-seo' ),
			...
			$this->render_view(
				...
				array(
					...
					'tab_name'      => __( 'User Roles', 'smartcrawl-seo' ),
			...
			<?php if ( $show_data_settings ) : ?>
				...
				$this->render_view(
					...
					array(
						'tab_id'       => 'tab_data',
						'tab_name'     => esc_html__( 'Data & Settings', 'smartcrawl-seo' ),
						'is_active'    => 'tab_data' === $active_tab,
						'tab_sections' => array(
							array(
								'section_description' => esc_html__( 'Control what to do with your settings and data. Settings are each module’s configuration options, Data includes the stored information like logs, SEO audit results and other bits of information stored over time.', 'smartcrawl-seo' ),
			...
			$this->render_view(
				...
				array(
					...
					'tab_name'     => __( 'Accessibility', 'smartcrawl-seo' ),
					'is_active'    => 'tab_accessibility' === $active_tab,
					'tab_sections' => array(
						array(
							'section_description' => esc_html__( 'Enable support for any accessibility enhancements available in the plugin interface.', 'smartcrawl-seo' ),
			...
			<form method='post' enctype="multipart/form-data" class="wds-form">
				...
				$this->render_view(
					...
					array(
						...
						'tab_name'     => __( 'Import', 'smartcrawl-seo' ),
