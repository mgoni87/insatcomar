...
<div id="wds-settings-access" class="sui-box-settings-row">
	...
	<div class="sui-box-settings-col-2">
		...
		><?php esc_html_e( 'In page SEO meta box', 'smartcrawl-seo' ); ?></label>
		<span class="sui-description"><?php esc_html_e( 'Choose what user level you want to be able to edit individual post and page meta tags.', 'smartcrawl-seo' ); ?></span>
		...
		<label
			...
			class="sui-settings-label"
		><?php esc_html_e( '301 Redirections', 'smartcrawl-seo' ); ?></label>
		<span class="sui-description"><?php esc_html_e( 'Choose what user level has the ability to add 301 redirects to individual posts and pages.', 'smartcrawl-seo' ); ?></span>
		...
		<label
			...
			class="sui-settings-label"
		><?php esc_html_e( 'Show Moz data to roles', 'smartcrawl-seo' ); ?></label>
		<span class="sui-description"><?php esc_html_e( 'Choose what user level gets to view the Moz data.', 'smartcrawl-seo' ); ?></span>
