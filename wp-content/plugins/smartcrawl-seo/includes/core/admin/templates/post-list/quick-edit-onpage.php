...
<fieldset class="inline-edit-col-left">
	<div class="inline-edit-col long-label">
		<h4>
			<?php if ( $show_title ) : ?>
				<?php echo esc_html( \smartcrawl_get_plugin_title() ); ?>
			<?php endif; ?>
		</h4>
		<label>
			<span class="title"><?php esc_html_e( 'Title Tag', 'smartcrawl-seo' ); ?></span>
	...
	<div class="inline-edit-col long-label">
		<label>
			<span class="title metadesc"><?php esc_html_e( 'Meta Description', 'smartcrawl-seo' ); ?></span>
			<span class="input-text-wrap">
