			...
			>
				...
				<tr style="padding: 0; text-align: left; vertical-align: top;">
					<td
						...
						<p style="color: #1a1a1a;font-family: 'Roboto', Arial, sans-serif;font-size: 18px;font-weight: normal;line-height: 24px;margin: 30px 0 10px;padding: 0;text-align: left"><?php printf( esc_html__( 'Hi %s,', 'smartcrawl-seo' ), esc_attr( $username ) ); ?></p>
						...
						<p style="color: #1a1a1a;font-family: 'Roboto', Arial, sans-serif;font-size: 25px;font-weight: 700;line-height: 34px;margin: 0 0 5px;padding: 0;text-align: left;">
							<?php esc_html_e( 'Overall Score', 'smartcrawl-seo' ); ?>
						</p>
						...
						<p style="color: #1a1a1a;font-family: 'Roboto', Arial, sans-serif;font-size: 14px;letter-spacing: -0.23px;line-height: 22px;margin: 0 0 15px;padding: 0;text-align: left;">
							<?php esc_html_e( 'Here are your latest SEO test results.', 'smartcrawl-seo' ); ?>
						</p>
							...
							<tr style="background-color: #F2F2F2">
								<?php if ( 'both' === $device || 'desktop' === $device ) : ?>
									<td style="border-radius: 4px 0 0 0;color: #333333;font-family: 'Roboto', Arial, sans-serif;font-size: 12px;font-weight: 700;line-height: 27px; letter-spacing: -0.23px; text-align: center">
										...
										<span style="margin-left: 5px"><?php esc_html_e( 'Desktop', 'smartcrawl-seo' ); ?></span>
									</td>
								<?php endif; ?>
								<?php if ( 'both' === $device || 'mobile' === $device ) : ?>
									<td style="border-radius: 0 4px 0 0;color: #333333;font-family: 'Roboto', Arial, sans-serif;font-size: 12px;font-weight: 700;line-height: 27px; letter-spacing: -0.23px; text-align: center">
										<img
											...
											style="height: 16px;vertical-align: middle;">
										<span style="margin-left: 5px"><?php esc_html_e( 'Mobile', 'smartcrawl-seo' ); ?></span>
									</td>
								<?php endif; ?>
							</tr>
							</thead>
												...
												<td style="text-align: left">
													<?php if ( 'a' === $desktop_report->get_score_grade() ) : ?>
														<img
															...
															alt="<?php esc_attr_e( 'Ok', 'smartcrawl-seo' ); ?>"
													...
													<?php elseif ( 'c' === $desktop_report->get_score_grade() ) : ?>
														<img
															...
															alt="<?php esc_attr_e( 'Warning', 'smartcrawl-seo' ); ?>"
															style="-ms-interpolation-mode: bicubic; border: none; height: 16px; outline: none; text-decoration: none; width: auto;"/>
													<?php elseif ( 'f' === $desktop_report->get_score_grade() ) : ?>
														<img
															src="<?php echo esc_url( $icon_error ); ?>"
															alt="<?php esc_attr_e( 'Critical', 'smartcrawl-seo' ); ?>"
															style="-ms-interpolation-mode: bicubic; border: none; height: 16px; outline: none; text-decoration: none; width: auto;"
														/>
													<?php endif; ?>
												</td>
						...
						<p style="color: #1a1a1a;font-family: 'Roboto', Arial, sans-serif;font-size: 25px;font-weight: 700;line-height: 34px;margin: 0 0 5px;padding: 0;text-align: left;">
							<?php esc_html_e( 'SEO Audits', 'smartcrawl-seo' ); ?>
						</p>

						<p style="color: #1A1A1A;font-family: 'Roboto', Arial, sans-serif;font-size: 14px;letter-spacing: -0.23px;line-height: 22px;margin: 0 0 15px;padding: 0;text-align: left;">
							<?php esc_html_e( 'These SEO audits ensure that your page is optimized for search engine results ranking. We recommend actioning as many as possible.', 'smartcrawl-seo' ); ?>
						</p>
									...
									<?php if ( 'both' === $device || 'desktop' === $device ) : ?>
										<td style="padding: 0 10px;color: #333333;font-family: 'Roboto', Arial, sans-serif;font-size: 12px;font-weight: 700;line-height: 27px; letter-spacing: -0.23px; text-align: center; width:75px;">
											<img
												...
												style="height: 16px;vertical-align: middle;"
											>
											<span style="margin-left: 5px; vertical-align: top;"><?php esc_html_e( 'Desktop', 'smartcrawl-seo' ); ?></span>
										</td>
									<?php endif; ?>
									...
									<?php if ( 'both' === $device || 'mobile' === $device ) : ?>
										<td style="padding: 0 10px;border-radius: 0 4px 0 0;color: #333333;font-family: 'Roboto', Arial, sans-serif;font-size: 12px;font-weight: 700;line-height: 27px; letter-spacing: -0.23px; text-align: center; width: 70px">
											<img
												...
												style="height: 16px;vertical-align: middle;"
											>
											<span style="margin-left: 5px; vertical-align: top;"><?php esc_html_e( 'Mobile', 'smartcrawl-seo' ); ?></span>
										</td>
									<?php endif; ?>
								</tr>
								</thead>
						...
						<p style="color: #1A1A1A;font-family: 'Roboto', Arial, sans-serif;font-size: 16px;font-weight: normal;line-height: 20px;margin: 0 0 20px;padding: 0;text-align: center">
							...
							>
								<?php esc_html_e( 'View full report', 'smartcrawl-seo' ); ?>
							</a>
						</p>
						...
						<p style="margin: 0 0 30px;padding: 0;text-align: center">
							...
							>
								<?php esc_html_e( 'Customize email report', 'smartcrawl-seo' ); ?>
							</a>
						</p>

						<?php if ( ! $hide_branding ) : ?>
							<p style="color: #1A1A1A;font-family: 'Roboto', Arial, sans-serif;font-size: 15px;font-weight: normal;line-height: 20px;margin: 0 0 20px;padding: 0;text-align: left;clear: both"><?php esc_html_e( 'Stay optimized.', 'smartcrawl-seo' ); ?></p>
							<strong><?php esc_html_e( 'SmartCrawl', 'smartcrawl-seo' ); ?></strong>
							<p style="color: #1A1A1A;font-family: 'Roboto', Arial, sans-serif;font-size: 15px;font-weight: normal;line-height: 15px;margin: 10px 0 15px;padding: 0;text-align: left"><?php esc_html_e( 'WPMU DEV SEO Hero', 'smartcrawl-seo' ); ?></p>
						<?php endif; ?>
					</td>
				</tr>
				</tbody>
