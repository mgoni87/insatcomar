...
<div class="<?php echo $is_active ? 'active' : ''; ?>">
	<div class="wds-metabox-section wds-advanced-metabox-section sui-box-body">
		<p><?php esc_html_e( 'Configure the advanced settings for this term.', 'smartcrawl-seo' ); ?></p>

		<div class="sui-box-settings-row">
			<div class="sui-box-settings-col-1">
				<label class="sui-settings-label"><?php esc_html_e( 'Indexing', 'smartcrawl-seo' ); ?></label>
				<p class="sui-description">
					<?php esc_html_e( 'Choose how search engines will index the term archive.', 'smartcrawl-seo' ); ?>
				</p>
			</div>
				...
				if ( $global_noindex ) {
					$this->render_view(
						...
						array(
							...
							'item_label'       => esc_html__( 'Index - Override Taxonomy Setting', 'smartcrawl-seo' ),
							'item_description' => esc_html__( 'Instruct search engines whether or not you want this term archive to appear in search results.', 'smartcrawl-seo' ),
						)
					);
				} else {
					$this->render_view(
				...
				if ( $global_nofollow ) {
					$this->render_view(
						...
						array(
							...
							'item_label'       => esc_html__( 'Follow - Override Taxonomy Setting', 'smartcrawl-seo' ),
							'item_description' => esc_html__( 'Tells search engines whether or not to follow the links on your term archive and crawl them too.', 'smartcrawl-seo' ),
						)
					);
				} else {
					$this->render_view(
		...
		<div class="sui-box-settings-row">
			<div class="sui-box-settings-col-1">
				...
				<p class="sui-description">
					<?php esc_html_e( 'The canonical link is shown on the archive page for this term.', 'smartcrawl-seo' ); ?>
				</p>
			</div>
			<div class="sui-box-settings-col-2">
				<input
				...
				<span class="sui-description">
					<?php esc_html_e( 'Enter the full canonical URL including http:// or https://', 'smartcrawl-seo' ); ?>
				</span>
			</div>
		</div>
	</div>
