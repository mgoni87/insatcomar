...
<li id="wds-sitemap-summary">
	...
	<span class="sui-list-detail">
		<?php if ( ! $is_member ) : ?>
			<span class="sui-tag sui-tag-inactive"><?php esc_html_e( 'No Data Available', 'smartcrawl-seo' ); ?></span>
		...
		<?php else : ?>
			...
			>
				<span class="sui-loading-text"><?php esc_html_e( 'Activate Sitemap', 'smartcrawl-seo' ); ?></span>
