...
$this->render_view(
	...
	array(
		...
		'description'             => sprintf(
			...
			esc_html__( 'Welcome to %1$s%3$s%2$s, the hottest SEO plugin for WordPress! Let\'s quickly set up the basics for you, then you can fine tune each setting as you go - our recommendations are on by default.', 'smartcrawl-seo' ),
			'<strong>',
			'</strong>',
