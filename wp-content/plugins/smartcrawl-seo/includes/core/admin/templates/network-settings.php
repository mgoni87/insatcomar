...
<div id="container" class="<?php \smartcrawl_wrap_class( 'wds-page-network-settings' ); ?>">
	...
	$this->render_view(
		'page-header',
		array(
			'title' => esc_html__( 'Network Settings', 'smartcrawl-seo' ),
		)
	);
	?>
		...
		<div class="wds-vertical-tabs-container sui-row-with-sidenav">
				...
				<ul class="sui-vertical-tabs">
					<li class="sui-vertical-tab tab_network_settings current">
						<a role="button" data-target="tab_network_settings" href="#">
							<?php esc_html_e( 'Permissions', 'smartcrawl-seo' ); ?>
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="wds-vertical-tab-section sui-box tab_network_settings " id="tab_network_settings">
				<div class="sui-box-header">
					<h2 class="sui-box-title"><?php esc_html_e( 'Permissions', 'smartcrawl-seo' ); ?></h2>
				</div>
				...
				<div class="sui-box-body">
					...
					<div class="sui-box-settings-row">
						<div class="sui-box-settings-col-1">
							<label class="sui-settings-label"><?php esc_html_e( 'Sub-site Settings', 'smartcrawl-seo' ); ?></label>
							<p class="sui-description">
								<?php esc_html_e( 'Configure how much control your sub-site admins have over their sites.', 'smartcrawl-seo' ); ?>
							</p>
						</div>
						...
						<div class="sui-box-settings-col-2">
							...
							>
								<?php esc_html_e( 'Admin Access', 'smartcrawl-seo' ); ?>
							</label>
							<p class="sui-description">
								<?php esc_html_e( 'Choose whether Super Admins or Site Admins should control sub-site settings.', 'smartcrawl-seo' ); ?>
							</p>
							<div class="sui-row">
								<div class="sui-col-md-6">
									...
									>
										<option <?php selected( 'admin', $subsite_manager_role ); ?>
											value="admin">
											<?php esc_html_e( 'Site Admins', 'smartcrawl-seo' ); ?>
										</option>
										<option <?php selected( 'superadmin', $subsite_manager_role ); ?>
											value="superadmin">
											<?php esc_html_e( 'Super Admins', 'smartcrawl-seo' ); ?>
										</option>
									</select>
								</div>
							</div>
							...
							<div class="wds-separator-top">
								<label
									...
									for="wds-subsite-access"
								>
									<?php esc_html_e( 'Modules', 'smartcrawl-seo' ); ?>
								</label>
								<p class="sui-description">
									<?php esc_html_e( 'Choose which modules should be available on sub-sites.', 'smartcrawl-seo' ); ?>
								</p>
								<?php
							...
							<div class="wds-separator-top">
								...
								>
									<?php esc_html_e( 'New Sub-sites', 'smartcrawl-seo' ); ?>
								</label>
								<p class="sui-description">
									<?php
									echo wp_kses_post(
				...
				<div class="sui-box-footer">
					...
					>
						...
						<?php esc_html_e( 'Save Changes', 'smartcrawl-seo' ); ?>
					</button>
				</div>
			</div>
		</div>
