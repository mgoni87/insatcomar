...
$this->render_view(
	...
	array(
		...
		'description'   => sprintf(
			...
			esc_html__( 'The powerful %1$s%3$s%2$s sitemap ensures search engines index all of your posts and pages. Are you sure you wish to switch to the WordPress core sitemap?', 'smartcrawl-seo' ),
			'<strong>',
			'</strong>',
