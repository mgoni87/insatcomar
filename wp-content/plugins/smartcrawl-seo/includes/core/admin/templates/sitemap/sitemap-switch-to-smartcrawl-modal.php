...
$this->render_view(
	...
	array(
		...
		'description'   => sprintf(
			...
			esc_html__( 'Please confirm that you wish to switch to %1$s%3$s%2$s\'s powerful sitemap. You can switch back to the WordPress core sitemap at anytime.', 'smartcrawl-seo' ),
			'<strong>',
			'</strong>',
