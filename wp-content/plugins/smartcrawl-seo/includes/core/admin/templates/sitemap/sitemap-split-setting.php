...
<div id="wds-sitemap-structure" class="sui-box-settings-row">
	<div class="sui-box-settings-col-1">
		...
		<p class="sui-description">
			<?php esc_html_e( 'Your sitemap will be split into multiple files as your site grows larger. Sitemap files are all listed in your sitemap index.', 'smartcrawl-seo' ); ?>
		</p>
	</div>
		...
		<div class="sui-row">
			<div class="sui-form-field sui-col">
				<label for="items-per-sitemap" class="sui-label">
					<?php echo esc_html__( 'Number of links per sitemap', 'smartcrawl-seo' ); ?>
				</label>
				<input
					type="number"
				...
				<p class="sui-description">
					...
					printf(
						...
						esc_html__( 'Choose how many URLs each sitemap has, up to %s. A higher number will use more server resources to generate.', 'smartcrawl-seo' ),
