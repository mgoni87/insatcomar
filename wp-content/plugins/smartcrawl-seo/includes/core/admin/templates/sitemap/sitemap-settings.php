			...
			<div class="wds-vertical-tabs-container sui-row-with-sidenav" id="sitemap-settings-tabs">
				...
				$this->render_view(
					...
					array(
						...
						'tab_sections' => array(
							array(
								'section_description' => $override_native ? esc_html__( 'Automatically generate a sitemap and regularly send updates to Google.', 'smartcrawl-seo' ) : esc_html__( 'Set up your sitemaps to tell search engines what content you want them to crawl and index.', 'smartcrawl-seo' ),
				...
				if ( $sitemap_crawler_available ) {
					$this->render_view(
						...
						array(
							...
							'tab_name'            => esc_html__( 'Crawler', 'smartcrawl-seo' ),
