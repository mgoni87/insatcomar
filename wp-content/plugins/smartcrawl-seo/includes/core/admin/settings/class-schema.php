...
class Schema extends Admin_Settings {
	...
	public function get_title() {
		return __( 'Schema', 'smartcrawl-seo' );
	}
	...
	private function get_lhs_text( $lhs ) {
		$texts = array(
			'post_type'     => __( 'Post type', 'smartcrawl-seo' ),
			'show_globally' => __( 'Show Globally', 'smartcrawl-seo' ),
			'homepage'      => __( 'Homepage', 'smartcrawl-seo' ),
			'author_role'   => __( 'Author role', 'smartcrawl-seo' ),
			'post_format'   => __( 'Post format', 'smartcrawl-seo' ),
			'page_template' => __( 'Page template', 'smartcrawl-seo' ),
			'product_type'  => __( 'Product type', 'smartcrawl-seo' ),
		);
		if ( isset( $texts[ $lhs ] ) ) {
			return $texts[ $lhs ];
		}
	...
	private function get_rhs_text( $lhs, $rhs ) {
		$product_types = array(
			'WC_Product_Variable' => __( 'Variable Product', 'smartcrawl-seo' ),
			'WC_Product_Simple'   => __( 'Simple Product', 'smartcrawl-seo' ),
			'WC_Product_Grouped'  => __( 'Grouped Product', 'smartcrawl-seo' ),
			'WC_Product_External' => __( 'External Product', 'smartcrawl-seo' ),
		);
		switch ( $lhs ) {
			case 'post_type':
	...
	private function get_post_types() {
		...
		foreach (
			...
			$post_types[ $post_type ] = isset( $pt->labels->archives ) && $pt->labels->archives !== $pt->label
				? $pt->labels->archives
				: $pt->label . ' ' . esc_html__( 'Archive', 'smartcrawl-seo' );
		}
