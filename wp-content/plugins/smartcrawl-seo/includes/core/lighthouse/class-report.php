...
class Report {
	...
	public function get_last_checked( $format = false ) {
		...
		if ( empty( $format ) ) {
			return sprintf(
				...
				esc_html__( '%1$s at %2$s', 'smartcrawl-seo' ),
	...
	public function get_status_message() {
		if ( 100 === $this->score ) {
			return esc_html__( 'Excellent! Your site is fully optimized!', 'smartcrawl-seo' );
		} elseif ( $this->score > 89 ) {
			return esc_html__( 'Follow the pending SEO audits for a perfect SEO score.', 'smartcrawl-seo' );
		} elseif ( $this->score > 49 ) {
			return esc_html__( 'You can improve your score by following the outstanding SEO audits.', 'smartcrawl-seo' );
		} else {
			return esc_html__( 'You need to improve your score by following the outstanding SEO audits.', 'smartcrawl-seo' );
		}
	}
