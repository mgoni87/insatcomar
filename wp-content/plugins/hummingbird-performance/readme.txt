...
- Asset Optimization – Combine, compress and position Javascript, CSS, and Google Font files for top performance. Test changes with built-in Safe Mode.
...
Did you know that loading too many files in your site's header can slow it down? Hummingbird now gives you granular control with separate Combine and Compress optimization modes, so you can fine tune your Asset Optimization like a pro. You can get advanced control with the Dev mode that let's you safely test the changes before going live. Reorder, defer, compress and exclude CSS and JavaScript files with one-click.
...
1. Performance test.
2. Full-page, browser and gravatar caching.
3. Minify and combine files to speed up your site.
4. Save space and speed things up.
...
- Improvement: Replace the Manual Asset Optimization tab with a Dev Mode link
- Improvement: Asset Optimization Scan assets in the background
- Fix: Enhance core files to prevent AO file overload by other plugins
