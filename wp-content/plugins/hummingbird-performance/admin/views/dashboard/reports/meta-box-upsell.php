		...
		<div class="sui-notice sui-notice-blue">
			<div class="sui-notice-content">
				<div class="sui-notice-message">
					...
					<p><a class="sui-button wphb-hub-connector-upsell-button" href="<?php echo esc_url( Hub_Connector::get_connect_site_url( 'wphb-notifications', 'hummingbird_dash_reports_connect_link' ) ); ?>" onclick="window.wphbMixPanel.trackHBUpsell( 'notifications', 'dash_widget', 'cta_clicked', this.href, 'hb_notifications_upsell' );">
